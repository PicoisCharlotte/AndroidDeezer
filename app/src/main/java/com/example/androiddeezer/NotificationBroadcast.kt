...
class NotificationBroadcast : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == NotificationGenerator.NOTIFY_PLAY) {
           ...
           // NotificationGenerator.launchNotif(notificationManager, context, "Titre",  R.drawable.ic_action_pause)
            NotificationGenerator.launchNotif(context, "EN bas ",  R.drawable.ic_action_fast_backward)
